...
const BG_STOPS = [
  { at: 0, c: [250, 250, 250] },
  { at: 0.3, c: [254, 252, 232] },
  { at: 0.6, c: [253, 242, 248] },
  { at: 1.0, c: [239, 246, 255] },
];
...
const P = {
  hero: [0, 0, 0.12, 0.2] as const,
  phil: [0.15, 0.22, 0.36, 0.43] as const,
  prog: [0.38, 0.45, 0.58, 0.65] as const,
  trust: [0.6, 0.67, 0.78, 0.85] as const,
  cta: [0.8, 0.88, 1.0, 1.0] as const,
};
...
export default function ScrollStorySection() {
  const progress = useSyncExternalStore(subscribeToScroll, getScrollProgress, () => 0);
  ...
  const cO = phaseOpacity(progress, ...P.cta);
  const cY = phaseY(progress, ...P.cta);

  return (
    <div
      style={{ height: "500vh", backgroundColor: getBg(progress) }}
          ...
          >
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 items-center gap-8 md:gap-10">
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg md:text-xl text-gray-600 font-medium max-w-2xl mx-auto lg:mx-0">
              ...
              <Image
                ...
                height={420}
                priority
                className="w-full max-w-xl lg:max-w-2xl h-auto max-h-[34vh] object-contain mx-auto drop-shadow-[0_18px_35px_rgba(17,24,39,0.12)]"
              />
            </div>
          </div>
        )}
        ...
        {pO > 0 && (
          ...
          >
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 items-center gap-8 md:gap-10">
              ...
              <Image
                src="/images/philosophy-curiosity.png"
                alt="Teacher guiding children through reading and art"
                width={700}
                height={420}
                loading="lazy"
                className="order-1 lg:order-2 w-full max-w-xl lg:max-w-2xl h-auto max-h-[34vh] object-contain mx-auto rounded-3xl border border-white/80 bg-white/70 p-2 sm:p-3 shadow-lg"
              />
            </div>
          </div>
        )}
        ...
        {prO > 0 && (
          ...
          >
            <div className="w-full max-w-6xl text-center">
              ...
              <Image
                src="/images/programs-learning.png"
                alt="Children in different classroom learning zones"
                width={920}
                height={470}
                loading="lazy"
                className="mt-8 sm:mt-10 w-full max-w-4xl h-auto max-h-[36vh] object-contain mx-auto rounded-3xl border border-white/70 bg-white/75 p-2 sm:p-3 shadow-lg"
              />
            </div>
          </div>
        )}
          ...
          >
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 items-center gap-8 md:gap-10">
              <Image
                ...
                height={420}
                loading="lazy"
                className="w-full max-w-xl lg:max-w-2xl h-auto max-h-[34vh] object-contain mx-auto rounded-3xl border border-white/70 bg-white/80 p-2 sm:p-3 shadow-lg"
              />
              <div className="text-center lg:text-left">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-md bg-white/60 backdrop-blur-sm p-5 sm:p-6 rounded-3xl shadow-sm border border-white mx-auto lg:mx-0">
                  Qualified teachers and a joyful environment designed specifically to give parents
          ...
          >
            <div className="bg-white/90 backdrop-blur-xl p-6 sm:p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-white/80 w-full max-w-5xl flex flex-col items-center max-h-[90vh] overflow-y-auto">
              <Image
                ...
                height={250}
                priority
                className="w-full max-w-sm lg:max-w-md h-auto max-h-[16vh] shrink-0 object-contain mb-4 mx-auto drop-shadow-md"
              />
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-stretch">
                ...
                <div className="flex flex-col justify-center gap-4 w-full h-full">
                  {/* Email */}
                  <a
                    href="mailto:shanepereira30@gmail.com"
                  ...
                  >
                    ...
                    <div className="text-left overflow-hidden">
                      ...
                      <p className="text-gray-700 font-medium truncate">shanepereira30@gmail.com</p>
                    </div>
                  </a>
